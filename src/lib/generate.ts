 ...
 *
 * Generating a toolpath is expensive — up to ~130ms for a V-carve — so it runs
...
export const generate = (
	...
	if (project.text.strategy === "vcarve") {
		notes.push(
			"V-carve is generated by progressive offsets, not a medial axis - verify depth on scrap first",
		);
	}
